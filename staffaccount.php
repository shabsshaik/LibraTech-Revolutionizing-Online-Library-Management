...
<FORM ACTION="stafnew.php" METHOD="POST" enctype="multipart/form-data">
<center>
<b><H1 style="margin: 20px 0;"><u>EMPLOYEE REGISTRATION FORM </u></b></center></h1>
<center>
<table  border="0" cellpadding="20" style="box-shadow: 0 0 8px 0 #999;">
<tr>
<td>
...
<tr>
<td>
<big>DEPARTMENT:</big></td>
<td>
<select name="r4" class="pay"  >
...
<td>
<input type="tel" name="r5" PLACEHOLDER="Enter........." pattern="[6789][0-9]{9}" required="required" class="pay"></INPUT></td></tr>
<tr>
<td>
<big>E-MAIL: </big></td>
<td>
<input type="email" name="r6" PLACEHOLDER="Enter........." required="required" class="pay"></INPUT></td></tr>
<tr><td>
<big>UPLOAD IMAGE: </big>
</td>
<td><input type="file" id="file" name="file" required="required" ></td></tr>
<tr>
<td colspan="2">
<center>
