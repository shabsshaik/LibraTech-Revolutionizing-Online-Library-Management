...
<B><H1 style="margin: 0px 0;"><u>STUDENT SECTION</b></H1><BR></u>
<div class="col-md-8">
                                          ...
                                          foreach($book as $yes)
                                            {
                                              ...
                                              if($no=='no')
                                              {
                                        $reg = "SELECT reg_no FROM istable WHERE book_no='$stud_id'";
                                          ...
                                          foreach($regno as $ras)
                                           {
                                            ...
                                            $re=$ras['reg_no'];
					                             ...
					                             $query = "SELECT * FROM newreg WHERE reg_no='$re'";
...
<td>
<a href='remove.php?delete=$row[book_no]'> RETURN </a></td>
</tr>
