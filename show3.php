...
<div class="topnav">
 ...
 <h1 align="center"  style="margin: 20px 0;"><u>FILTER BOOKS-STAFF</h1></u>
   
<div class="form-group">
    <div class="input-group">


 <table border="1" bgcolor="linen"><tr><th> <span class="input-group-addon"><big></span> <input type="search" name="search_text" id="search_text" placeholder="Searching Here" class="pay" style="height:4vh; width:190vh" /> </th></tr></table>
...
{
  $alert="<script>alert('Please Login...!!');</script>";
  echo $alert; 
  session_destroy();
  echo "<script>
