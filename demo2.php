...
$sq = "SELECT COUNT(*) FROM istable where reg_no!='0'";
$count =0;
...
$query = "
  SELECT * FROM istable
  WHERE reg_no LIKE '%".$search."%' ORDER BY issue_date desc
...
{
 $query = "SELECT * from istable where reg_no!='0' ORDER BY issue_date desc";
...
<td bgcolor=#f77474>
<a href='div.php?delete=$row[reg_no]'>" .$row['reg_no']."</a></td>
