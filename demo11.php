...
<html>
<head>
<title>Daily Record of Employee</title>
...
<h1 align="center" style="margin: 20px 0;"><u>FILTER BOOKS-EMPLOYEE</h1></u>
 
<center>
<table border="1" cellpadding="30">
<tr>
<th><big><big>EMPLOYEE ID</th>
...
$sql="SELECT * from istable where staff_id!='0'";
...
<td><font color=red>" .$row['return_date']."</td>
 ";
  ...
  $count=$count+1;
    echo "
<tr>
<td bgcolor=#f77474>" .$row['staff_id']."</td>
